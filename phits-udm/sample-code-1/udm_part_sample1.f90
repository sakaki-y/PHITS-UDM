...
! Default variables
!-----------------------------------------------------------------------
character(len=99), parameter :: Name = "my_particle_1" ! This 'Name' is used in input files.
...
!=======================================================================
lifetime=0.1e-9 ! 0.1 nano second
return
end
