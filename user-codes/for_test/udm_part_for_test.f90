...
! if(0.5 > get_random_0to1()) then
  call two_body_decay_uniform(900001,900001)      ! X -> 2 neutrinos (50%)
! else
!   call three_body_decay_uniform(900001,900001,900001) ! X -> 3 neutrinos (50%)
! endif
